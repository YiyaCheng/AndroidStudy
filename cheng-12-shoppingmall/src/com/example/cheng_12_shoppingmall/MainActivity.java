...
import com.example.cheng_12_shoppingmall.adapter.list2Adapter;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Map;

import com.example.cheng_12_shoppingmall.adapter.list1Adapter;
import com.example.cheng_12_shoppingmall.adapter.addAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					searchgoods.clear();
					list1Adapter la2=new list1Adapter(getApplicationContext(),searchgoods);
					lv2.setAdapter(la2);	
					ac.setText("");
				}
					}
